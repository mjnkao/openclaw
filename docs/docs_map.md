...
## specs/durable-core-architecture.md

- Route: /specs/durable-core-architecture
- Headings:
  - H1: Durable Core Residual-Gap Architecture
  - H2: Status
  - H2: Architecture Decision
  - H2: User Promise
  - H2: Longevity Boundary
  - H2: Layer Model
  - H2: Authority Modes
  - H2: Canonical Owner Adapter
  - H2: Source Contract
  - H2: Canonical Schema
  - H3: Reused tables
  - H3: New residual tables
  - H2: Wake Obligation
  - H2: Obligation Outbox And Reconciliation
  - H2: Obligation Dispatcher And No-Silence SLA
  - H2: Delivery Evidence
  - H2: Uncertainty And Replay
  - H2: Claims And Leases
  - H2: Restart And Compaction
  - H2: Result Handoff And Fan-In
  - H2: API And Authority
  - H3: Owner Decision Protocol
  - H2: Atomicity, Replay, And Crash Matrix
  - H2: Configuration
  - H2: Invariants
  - H2: Related
...
- Headings:
  - H1: Durable Core Missing-Fact Owner Map
  - H2: Rule
  - H2: Owner Inventory
  - H2: Owner Adapter Inventory
  - H2: Generic Execution Facts
  - H2: Residual Contract Facts
  - H2: Transaction And Reconciliation Map
  - H2: Target Resolution Sources
  - H2: Schema Decisions
  - H3: Keep and rename before upstreaming
  - H3: Remove
  - H2: Public Naming Gate
  - H2: Review Checklist
  - H2: Related

## specs/durable-core-test-plan.md

- Route: /specs/durable-core-test-plan
- Headings:
  - H1: Durable Core Residual-Gap Test Plan
  - H2: Proof Principle
  - H2: Required Proof Matrix
  - H2: Schema Tests
  - H3: Existing owners remain present
  - H3: Residual tables are exact
  - H3: Source shape
  - H3: Future schema and migration failure
  - H3: Authority and degraded mode
  - H2: Existing-Owner Compatibility Tests
  - H3: Tasks and Task Flow
  - H3: Subagents
  - H3: Delivery queues
  - H3: Restart and sessions
  - H2: Wake Obligation Scenarios
  - H2: Owner Adapter And Outbox Scenarios
  - H2: Obligation Dispatcher And SLA Scenarios
  - H2: Uncertainty And Replay Scenarios
  - H2: Claim And Lease Scenarios
  - H2: Restart Scenarios
  - H2: Context Overflow And Compaction
  - H2: CLI Contract
  - H2: Gateway Contract
  - H2: Naming Guard
...
## specs/durable-core-upstream-7.1-gap-analysis.md

- Route: /specs/durable-core-upstream-7.1-gap-analysis
- Headings:
  - H1: Durable Core Upstream 7.1 Gap Analysis
  - H2: Decision Summary
  - H2: Baseline And Evidence
  - H2: Why A Residual Durable Core Is Still Required
  - H2: Failure-Mode Gap Matrix
  - H2: Existing Schema Inventory
  - H3: Reuse As Canonical Owners
  - H3: New Tables That Are Justified
  - H3: Proposed Tables That Are Not Justified
  - H2: Pre-Refactor Durable Branch Assessment
  - H2: Refactor Outcome
  - H2: Existing API And CLI Surface
  - H3: Official 7.1
  - H3: Required Additive Durable Surface
  - H2: Required Runtime Flow
