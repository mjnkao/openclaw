...
export type WakeObligationControlParams = SchemaType<"WakeObligationControlParams">;
export type WakeObligationSupersedeParams = SchemaType<"WakeObligationSupersedeParams">;
export type WakeObligationControlResult = SchemaType<"WakeObligationControlResult">;
export type UncertaintyFactListResult = SchemaType<"UncertaintyFactListResult">;
export type UncertaintyFactResolveParams = SchemaType<"UncertaintyFactResolveParams">;
export type UncertaintyFactResolveResult = SchemaType<"UncertaintyFactResolveResult">;
