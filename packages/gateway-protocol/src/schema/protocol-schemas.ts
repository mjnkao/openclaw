...
export const ProtocolSchemas = {
  ...
  DurableHealthGetParams: DurableHealthGetParamsSchema,
  DurableHealthResult: DurableHealthResultSchema,
  DurableLimitParams: DurableLimitParamsSchema,
  DurableObligationsListResult: DurableObligationsListResultSchema,
  WakeObligationListResult: WakeObligationListResultSchema,
  WakeObligationIdParams: WakeObligationIdParamsSchema,
  WakeObligationInspectResult: WakeObligationInspectResultSchema,
  WakeObligationControlParams: WakeObligationControlParamsSchema,
  WakeObligationSupersedeParams: WakeObligationSupersedeParamsSchema,
  WakeObligationControlResult: WakeObligationControlResultSchema,
  UncertaintyFactListResult: UncertaintyFactListResultSchema,
  UncertaintyFactResolveParams: UncertaintyFactResolveParamsSchema,
  UncertaintyFactResolveResult: UncertaintyFactResolveResultSchema,
  DeliveryAttemptEvidenceListParams: DeliveryAttemptEvidenceListParamsSchema,
  DeliveryAttemptEvidenceListResult: DeliveryAttemptEvidenceListResultSchema,
