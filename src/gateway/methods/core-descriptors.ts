...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "durable.health.get", scope: "operator.read" },
  { name: "durable.coordination.get", scope: "operator.read" },
  { name: "durable.obligations.list", scope: "operator.read" },
  { name: "durable.wakes.list", scope: "operator.read" },
  { name: "durable.wakes.inspect", scope: "operator.read" },
  { name: "durable.wakes.acknowledge", scope: "operator.write" },
  { name: "durable.wakes.resume", scope: "operator.write" },
  { name: "durable.wakes.supersede", scope: "operator.write" },
  { name: "durable.uncertainty.list", scope: "operator.read" },
  { name: "durable.uncertainty.resolve", scope: "operator.write" },
  { name: "durable.delivery-attempts.list", scope: "operator.read" },
